...
#### [float](https://developer.mozilla.org/fr/docs/Web/CSS/float) : right || left 
cf. [clear](https://developer.mozilla.org/fr/docs/Web/CSS/clear)
...
- :cat: [CSS & chats :us:](https://robots.thoughtbot.com/basic-css-selectors-explained-with-cats) : petite études sur les sélecteurs "hiérarchiques"
