...
- d'autre part l'exploration d'une nouvelle dimension, celles des tuyaux : le **back-end* aka côté serveur (obscure) avec PHP/MYSQL
...
- choix du projet perso & rédaction d'un "cahier des charges", début de maquettes
- intro au JS moderne
- intro au back-end
