...
![...](https://giphy.com/gifs/kanye-west-sorry-kS2qLKwGk3MXe)

### PHP 

[les différents exemples vus en exemples](https://github.com/simplyon2/exemples-php)

Plutôt qu'une "interro", voilà un petit défi que vous pouvez essayer de relever, seul ou en "pair-programming" aka binôme, en partie ou complet, avant vendredi 17h30 : 
...
1. vérifications : 
  ...
  - 4 chars minimum
  - mot de passe et confirmation identitique
  - checkbox
...
3. :cherries: 
  ...
  - ajoutez de la validation js : désactivez le bouton si des champs sont invalides
...
Écrivez une fonction(JS|PHP|ES6|TS|Dart|Python|Ruby...) de chiffrement et une de déchiffrement de chiffrement.
