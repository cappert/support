...
On accède aux différents élements d'un tableau grâce à son index exemple :
...
Tant qu'une condition est vraie » execute ces instructions
...
execute ces instructions tant qu'une condition est vraie
