...
Écrire une page php qui affiche les questions d'un QCM :

- une question
- 3 propositions images (radiobutton)

Variante : accepter une seule réponse et afficher le score après la dernière question.
